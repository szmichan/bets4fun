...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainMainCPH" runat="server">
    <div style="width: 100%; vertical-align: top;">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" RenderMode="Block">
            <ContentTemplate>
                <button type="button" class="btn btn-lg btn-primary m-2" data-target="#filters" data-toggle="collapse" aria-expanded="false" aria-controls="filters" onclick="checkToggle($(this),'Games.aspx/SaveCollapsedState')">Toggle Filters</button>
