...
<%--                <fieldset>
                <ol>
                    <li>
                        <asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="UserName" Text="Login:" CssClass="account_label"></asp:Label>
                        <asp:TextBox ID="UserName" runat="server" autocomplete="off"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="validation_error"
                            ControlToValidate="UserName" ErrorMessage="login jest wymagany" Text="login jest wymagany"
                            ToolTip="login jest wymagany" ValidationGroup="ResetPassword">*</asp:RequiredFieldValidator>
                    </li>
                    <li>
                        <asp:Label ID="EmailLabel" runat="server" AssociatedControlID="Email" Text="E-mail:" CssClass="account_label"></asp:Label>

                        <asp:TextBox ID="Email" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="EmailRequired" runat="server"
                            ControlToValidate="Email" ErrorMessage="email wymagany" Text="email wymagany" CssClass="validation_error"
                            ToolTip="email wymagany" ValidationGroup="ResetPassword">*</asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="rfvEmail" runat="server" ErrorMessage="email<br/> nieprawidłowy" CssClass="validation_error" ForeColor="" Font-Size="Small"
                            ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ControlToValidate="Email" Text="email nieprawidłowy" ValidationGroup="ResetPassword"></asp:RegularExpressionValidator>
                    </li>
                </ol>--%>
                <div class="mt-4 mb-4">
      ...
      <%--      </fieldset>--%>
        ...
        <asp:View ID="Success" runat="server">
            <table>
                    <tr>
                        <td>Your password was successfully reset. <br/> New password was sent on your e-mail. Password should be changed after first sign in.</td>
                    </tr>
                    <tr>
